...
| 3       | RACE-EVENT-IDENTITY-01 (optional race name)                               | Nested `raceGoal` metadata + sanitizer; nice identity win. (v2 slice 4b — still open.)                                                                                                                                                                                                                                                                                                                                                                         |
...
| built   | ROUTE-PLANNING-01 (Mapbox `planRunningRoute`)                             | **DECIDED 2026-07-17 (owner): Mapbox supersedes ORS**; Run11 Pro gate retained. Built on `claude/route-planning`, rebased onto current main. #1636 resolved (2026-07-18), so the only remaining gate is provisioning `MAPBOX_DIRECTIONS_TOKEN` in Secret Manager before merge. Rollout: `docs/road-aware-route-planning.md`.                                                                                                                                   |
