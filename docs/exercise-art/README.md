...
- New work: a complete six-slot dumbbell-curl **draft**, outside `public/`.
...
Its selector includes the seven existing sets and `db-curl (draft)`; both themes
and manual cues are available. Run `npm run dev -- --host 127.0.0.1` and open
