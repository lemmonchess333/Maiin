...
- New work: ten complete six-slot **draft** sequences, outside `public/`:
  ...
  back squat, barbell curl, dumbbell bench press bodyweight squat and a composited barbell shrug.
- Lat pulldown and deadlift have rejected incomplete pilots. Original generated shrug candidates remain rejected; the new composited shrug is a separate draft.
