...
export const BADGE_DEFINITIONS: BadgeDef[] = [
  ...
  { id: "protein_pro", name: "Protein Pro", description: "Hit protein target 7 days in a row", icon: "beef", lucideIcon: "Beef", tier: "gold", category: "nutrition" },
  { id: "hydration_hero", name: "Hydration Hero", description: "Hit water target 7 days in a row", icon: "droplets", lucideIcon: "Droplets", tier: "silver", category: "nutrition" },
  { id: "meal_prep_master", name: "Meal Prep Master", description: "Log all meals for 14 days straight", icon: "utensils-crossed", lucideIcon: "UtensilsCrossed", tier: "gold", category: "nutrition" },
