...
export const SPACE_DEFS: SpaceDef[] = [
  ...
  // Winter and spring: the catalogue had nothing between the New York
  // City Marathon and Brighton/Paris in April, so a runner planning a
  // spring marathon over winter saw an empty directory for five months.
  {
    id: "valencia-marathon",
    name: "Valencia Marathon",
    tagline: "December 42.2 finishing among the City of Arts and Sciences.",
    kind: "race",
    accent: "running",
    icon: "flag",
    event: {
  ...
  },
  {
    ...
    tagline:
      "January's big-city marathon, with a half and a 5K on the same weekend.",
    kind: "race",
    accent: "running",
    icon: "flag",
    event: {
  ...
  },
  {
    ...
    tagline: "February 42.2 through the old city to the Paseo de las Delicias.",
    kind: "race",
    accent: "running",
    icon: "flag",
    event: {
  ...
  },
  {
    ...
    tagline: "Seafront 13.1 at the end of February.",
    kind: "race",
    accent: "running",
    icon: "flag",
    event: {
      ...
      countryCode: "GB",
      countryFlag: "🇬🇧",
      websiteUrl: "https://brightonhalfmarathon.com/",
    },
  },
  {
    id: "tokyo-marathon",
    name: "Tokyo Marathon",
    tagline: "The World Marathon Major that opens the spring.",
    kind: "race",
    accent: "running",
    icon: "flag",
    event: {
  ...
  },
  {
    ...
    tagline: "13.1 through the colleges and out past the Backs.",
    kind: "race",
    accent: "running",
    icon: "flag",
    event: {
      ...
      countryCode: "GB",
      countryFlag: "🇬🇧",
      websiteUrl: "https://cambridgehalfmarathon.com/",
    },
  },
  {
    id: "bath-half",
    name: "Bath Half Marathon",
    tagline: "Two laps of the Georgian city in mid-March.",
    kind: "race",
    accent: "running",
    icon: "flag",
    event: {
      ...
      countryCode: "GB",
      countryFlag: "🇬🇧",
      websiteUrl: "https://www.londonmarathonevents.co.uk/bath-half",
    },
  },
  {
    id: "barcelona-marathon",
    name: "Barcelona Marathon",
    tagline: "March 42.2 past the Sagrada Família and back along the sea.",
    kind: "race",
    accent: "running",
    icon: "flag",
    event: {
