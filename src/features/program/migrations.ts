...
function migrateScheduledRunDay(
  ...
  /* Same offset rule as everywhere else: `weekStartDate` is the week's
     MONDAY and `dayIndex` is a day-of-week (0 = Sunday), so adding the
     index directly would repair a legacy runDay onto the wrong date. */
