...
// Read initial tab from query param (e.g. /history?tab=performance)
const initialTab = (searchParams.get(‘tab’) as FilterTab) || ‘all’;
const validTabs: FilterTab[] = [‘all’, ‘running’, ‘lifting’, ‘nutrition’, ‘performance’];
const [filter, setFilter] = useState<FilterTab>(
validTabs.includes(initialTab) ? initialTab : ‘all’
);

// Clear query param after reading so back-navigation doesn’t stick
useEffect(() => {
