      ...
      <div className="p-4 rounded-2xl bg-card border border-border/50 space-y-3">
        <button onClick={() => setExpanded(!expanded)} className="w-full flex items-center gap-3">
          ...
          <div className="flex-1 text-left">
            <p className="text-[10px] uppercase tracking-wider text-muted-foreground">Adaptive TDEE</p>
            <div className="flex items-center gap-2">
              <p className="text-sm font-semibold text-foreground">
                {tdeeResult.estimatedTDEE > 0 ? `${tdeeResult.estimatedTDEE} cal/day` : "Collecting data..."}
              </p>
              <span className="text-[9px] px-1.5 py-0.5 rounded-full font-medium" style={{ backgroundColor: confidenceColor + "20", color: confidenceColor }}>
                {tdeeResult.confidence}
              </span>
            </div>
          </div>
              ...
              <div className="pt-3 border-t border-border/30 space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 rounded-xl bg-muted/50">
                    <p className="text-[10px] text-muted-foreground">Estimated TDEE</p>
                    <p className="text-lg font-bold text-foreground">{tdeeResult.estimatedTDEE}</p>
                  </div>
                  <div className="p-3 rounded-xl bg-muted/50">
                    <p className="text-[10px] text-muted-foreground">Suggested Target</p>
