          ...
          <div className="flex-1 text-left">
            ...
            <div className="flex items-center gap-2">
              <p className="text-sm font-semibold text-foreground">
                {tdeeResult.estimatedTDEE > 0
                  ? `${tdeeResult.estimatedTDEE} cal/day`
                  : "Collecting data..."}
              </p>
              {isPro && (
                <span
              ...
              <div className="pt-3 border-t border-border/30 space-y-3">
                {isPro ? (
                  <>
                    ...
                    <div className="flex items-center gap-2 text-xs text-muted-foreground">
                      ...
                      <span>
                        ...
                        {tdeeResult.weeklyWeightChange >= 0 ? "+" : ""}
                        {tdeeResult.weeklyWeightChange.toFixed(2)}kg (target:{" "}
                        {tdeeResult.targetWeightChange >= 0 ? "+" : ""}
                        {tdeeResult.targetWeightChange.toFixed(1)}kg)
                      </span>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl bg-primary text-primary-foreground text-sm font-semibold"
                  >
                    Unlock adaptive adjustments with Pro
                  </button>
                )}
              </div>
            </motion.div>
