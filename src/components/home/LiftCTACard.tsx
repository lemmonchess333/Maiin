  ...
  return (
    <motion.button whileTap={{ scale: 0.97 }}
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-bold" style={{ background: `linear-gradient(135deg, ${THEME.lifting}, ${THEME.liftingLight})`, color: "white", boxShadow: 'var(--ds-shadow-cta-lift)' }}>
